...
<div class="container">
  ...
  <div id="btntxtalign">
  <a href="transaction_inbound_report_viewer.php"><button type="button" class="btn btn-primary">Show all data</button></a>
</div>
<br>


<div id="example3">
  <form action="transaction_inbound_bill_viewer.php" method="POST">
...
if($result=$conn->query($sql4))
    ...
    while($row=$result->fetch_object())
    {
    echo "<tr><td>$row->customer_name</td><td>$row->product_name</td><td>$row->tr_product_quantity</td><td>$row->tr_updated_date_time</td><td>$row->tr_updated_by</tr>";
    }
    }
    }
}
