...
$sql="INSERT INTO product_details (product_id, product_name, product_type, created_by, created_user_company_id) VALUES ('$product_uid','$product_name','$product_type', '$_SESSION[login_inv_user_email]', '$_SESSION[company_id_for_db_update]')";
$sql2="INSERT INTO product_pricing (product_pricing_id, product_name, product_type, quantity, current_rate, created_by, created_user_company_id) VALUES ('$product_uid','$product_name','$product_type','$product_quantity','$current_rate', '$_SESSION[login_inv_user_email]', '$_SESSION[company_id_for_db_update]')";
//echo $sql."<br><br>".$sql2;
