...
<div class="container">
  ...
  <?php
$sql ="SELECT cd.company_name, cd.company_id, ud.user_company_id, ud.user_email FROM company_details cd, user_details ud where ud.user_email = '$_SESSION[login_inv_user_email_viewer]' AND ud.user_company_id = cd.company_id";  
//echo $sql;
...
{
$_SESSION['company_name_for_displaying_viewer'] = $row->company_name;
$_SESSION['company_id_for_db_update_viewer'] = $row->company_id;
}
}
}
?>
  ...
  <div id="btntxtalign">
  <a href="transaction_outbound_bill_viewer.php"><button type="button" class="btn btn-primary">Filter by Month</button></a>
</div>
<br>
