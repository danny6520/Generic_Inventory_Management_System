...
foreach($product_id as $product_mapping_id)
{
    $mapping_uid = uniqid();

    $sql = "INSERT INTO company_product_mapping (mapping_id, company_id, product_id, mapping_updated_by) VALUES ('$mapping_uid','$company_id','$product_mapping_id','$_SESSION[login_admin_email]')";
...
if($query_run)
{
    ...
    echo "<script>location.href='company_product_mapping.php'</script>";
    }	
    else
    {
    echo "<h1>Loading..Please Wait..!</h1>";
