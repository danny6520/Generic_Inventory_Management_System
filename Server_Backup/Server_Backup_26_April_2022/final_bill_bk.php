...
<table border='1' cellspacing='10' cellpadding='20p'>
  <tr>  <th>Current Month Transaction</th><th>Customer Name</th><th>Product Name</th><th> Quantity</th><th>PRICE</th><th>Number of Days</th><th>TYPE</th><th>Total Price</th></tr>
  <?php
  ...
  $sql3 = " SELECT `tr_customer_id`,`tr_product_id`,`tr_product_quantity`,`tr_price`, tr_updated_date_time , DATE_FORMAT(`tr_updated_date_time`,'%Y/%m') as transaction_date, CONVERT( DATEDIFF(LAST_DAY(`tr_updated_date_time` + MONTH(`tr_updated_date_time`)) ,`tr_updated_date_time`),CHARACTER) as 'no_of_days' , `tr_type` as 'TYPE' ,  pd.product_name, pd.product_id, 
  ...
  $sql3 = $sql3 ." tb.tr_user_company_id = '$_SESSION[company_id_for_db_update]' order by tr_updated_date_time, cd.customer_name , pd.product_name , TYPE";
  echo $sql3;
