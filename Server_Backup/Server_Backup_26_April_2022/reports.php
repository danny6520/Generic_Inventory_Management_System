...
<div class="container">
  ...
  <label for="name">Select Company name:</label>
    <select name="company_name" onchange="showCustomer(this.value)" class="form-control">  
...
if(isset($_POST['submit']))
{
    ...
    $sql="SELECT company_name FROM company_details WHERE company_id='$company_name'";
//echo $sql;
...
{
?>
<h5>Company Name: <b> <?php echo $row->company_name; ?></b></h5><hr>
<?php
}}}
?>
<div style="overflow-x:auto;">
<table border='1' cellspacing='10' cellpadding='20p'>
  <tr>  <th>User Name</th><th>User Email</th><th>User Designation</th><th>User Role</th>  </tr>
<?php

if($user_designation == "all" && $user_role == "all" && $user_designation == "all")
{

  $sql3="SELECT * FROM user_details WHERE user_updated_by='$_SESSION[login_admin_email]'";
  //echo $sql2;
  ...
  while($row=$result->fetch_object())
  {
  echo "<tr><td>$row->user_name</td><td>$row->user_email</td><td>$row->user_designation</td><td>$row->user_role</td></tr>";
  }
  }
  }
...
$sql2="SELECT * FROM user_details WHERE user_company_id='$company_name' AND user_designation='$user_designation' AND user_role='$user_role' AND user_updated_by='$_SESSION[login_admin_email]'";
//echo $sql2;
