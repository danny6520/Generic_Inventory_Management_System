...
<br>
  <div id="example3">
  <form action="modify_products_process.php" method="POST">
    <label for="name">Select Product name to modify / delete:</label>
...
<br>
    <center><button type="submit" name="submit" class="btn btn-success">Modify</button> &nbsp; &nbsp;<button type="submit" name="submit_for_delete" class="btn btn-danger">Delete</button></center>
  </form>
</div>
</div>
