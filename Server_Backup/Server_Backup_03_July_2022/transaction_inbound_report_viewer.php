...
<div class="container">
  ...
  <hr>
  <div id="btntxtalign">
  <a href="transaction_inbound_bill_viewer.php"><button type="button" class="btn btn-primary">Filter by Month</button></a>
</div>
<br>
