...
{
$sql3 ="SELECT td.tr_id, td.tr_product_id, td.tr_product_quantity, pp.quantity, pp.product_pricing_id, pd.product_id FROM transaction_details td, product_details pd, product_pricing pp WHERE td.tr_id = '$_SESSION[outbound_tr_uid_for_update]' AND td.tr_product_id = pd.product_id AND pd.product_id = pp.product_pricing_id";  
//echo $sql;
