...
<div class="container">
  ...
  <div id="btntxtalign">
  <a href="transaction_outbound_report.php"><button type="button" class="btn btn-primary">Show all data</button></a>
</div>
<br>


<div id="example3">
  <form action="transaction_outbound_bill.php" method="POST">
