...
<div class="container">
  ...
  <div id="btntxtalign">
  <a href="add_to_existing_inventory.php"><button type="button" class="btn btn-primary">Existing Inventory</button></a>
</div>
<br>
...
?>
  ...
  <label for="name">Product Quantity:</label>
    ...
    <!-- label for="name">Add/Modify Product:</label>
    <select name="inv_type" class="form-control">  
      <option value="new">New Entry</option>  
      <option value="existing">Existing Entry</option>
    </select>
<br -->
