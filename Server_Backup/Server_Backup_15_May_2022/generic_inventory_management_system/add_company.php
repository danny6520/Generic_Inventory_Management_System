...
<select name="company_type" id="company_type" class="form-control">
  ...
  <option value="Branch">Branch</option>
    ...
    <input type="text" name="company_details" class="form-control" placeholder="About your Company" /required>
    <br>
    <label for="name">Company Head office:</label>
    <input type="text" name="company_head_office" class="form-control" placeholder="Enter Company Head office location" /required>
    <br>
