...
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '01', `tr_product_quantity`, 0)) as '01' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '02', `tr_product_quantity`, 0)) as '02' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '03', `tr_product_quantity`, 0)) as '03' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '04', `tr_product_quantity`, 0)) as '04' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '05', `tr_product_quantity`, 0)) as '05' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '06', `tr_product_quantity`, 0)) as '06' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '07', `tr_product_quantity`, 0)) as '07' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '08', `tr_product_quantity`, 0)) as '08' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '09', `tr_product_quantity`, 0)) as '09' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '10', `tr_product_quantity`, 0)) as '10' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '11', `tr_product_quantity`, 0)) as '11' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '12', `tr_product_quantity`, 0)) as '12' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '13', `tr_product_quantity`, 0)) as '13' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '14', `tr_product_quantity`, 0)) as '14' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '15', `tr_product_quantity`, 0)) as '15' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '16', `tr_product_quantity`, 0)) as '16' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '17', `tr_product_quantity`, 0)) as '17' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '18', `tr_product_quantity`, 0)) as '18' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '19', `tr_product_quantity`, 0)) as '19' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '20', `tr_product_quantity`, 0)) as '20' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '21', `tr_product_quantity`, 0)) as '21' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '22', `tr_product_quantity`, 0)) as '22' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '23', `tr_product_quantity`, 0)) as '23' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '24', `tr_product_quantity`, 0)) as '24' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '25', `tr_product_quantity`, 0)) as '25' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '26', `tr_product_quantity`, 0)) as '26' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '27', `tr_product_quantity`, 0)) as '27' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '28', `tr_product_quantity`, 0)) as '28' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '29', `tr_product_quantity`, 0)) as '29' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '30', `tr_product_quantity`, 0)) as '30' ,
sum(IF(DATE_FORMAT(tr_updated_date_time,'%d') = '31', `tr_product_quantity`, 0)) as '31' 
from transaction_details td, customer_details cd, product_details pd group by product_type, pd.product_id ,pd.product_name";
  ...
  echo $sql3;
    ...
    {
      echo "<tr><td>aaaa</td><td>$row->product_id</td><td>$row->product_name</td></tr>";
