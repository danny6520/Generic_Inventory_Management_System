...
<?php
  ...
  $sql3="SELECT 
pd.product_id,pd.product_name,pd.product_model,pp.current_rate, td.tr_updated_date_time, 
...
sum( `tr_product_quantity`) as 'total_qty' , (sum( `tr_product_quantity`)*pp.current_rate) as 'total_price' 
