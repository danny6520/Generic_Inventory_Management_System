...
if($customer_id == "na")
{
  ...
  echo "<script>location.href='transaction_inbound_other_dates.php'</script>";
}
else {
...
for($m = 0; $m < $_SESSION['req_quantity_array_limit']; $m++)
{
  ...
  $sql = "INSERT INTO transaction_details (tr_id, tr_customer_id, tr_product_id, tr_product_quantity, tr_price, tr_updated_by, tr_user_company_id, tr_type, tr_updated_date_time) VALUES ('$transaction_id_for_inbound_transaction','$customer_id','$product_id_array[$m]','$quantity_array[$m]','$inbound_price_array[$m]','$_SESSION[login_inv_user_email]','$_SESSION[company_id_for_db_update]','i','$inbound_date')";
  ...
  $sql6 = "INSERT INTO transaction_bill (tr_bill_id, tr_bill_customer_id, tr_bill_product_id, tr_bill_outbound_quantity, tr_bill_outbound_date_time, tr_bill_inbound_quantity, tr_bill_inbound_date_time, tr_bill_updated_by, tr_bill_user_company_id) VALUES ('$transaction_id_for_inbound_transaction','$customer_id','$product_id_array[$m]','$transaction_product_quantity_array[$m]','$transaction_outbound_date_time[$m]','$quantity_array[$m]','$inbound_date','$_SESSION[login_inv_user_email]','$_SESSION[company_id_for_db_update]')";
  //echo $sql6;
