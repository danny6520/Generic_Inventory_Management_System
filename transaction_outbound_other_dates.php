...
<?php
      ...
      {
        ?>
  <h1>Sales (for any dates)</h1>
  <?php
      }
      else {
        ?>
        <h1>Outbound Transaction (for any dates)</h1>
  <?php
      }
      ?>
  ...
  <div id="example3">
  <form action="transaction_outbound_other_dates_process.php" method="POST">
...
<input type="datetime-local" name="outbound_date" class="form-control" /required>
    <br>
