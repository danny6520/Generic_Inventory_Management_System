...
//start 
 ...
 if(isset($_POST['submit']))
 {
  ...
  //$sql = "UPDATE product_details SET product_name='$product_name', quantity='$product_quantity', current_rate='$current_rate' WHERE product_id='$_SESSION[product_id_for_update]'";
  $sql = "UPDATE product_details pd, product_pricing pp SET pd.product_name='$product_name', pp.product_name='$product_name', pp.quantity='$product_quantity', pp.current_rate='$current_rate' WHERE pd.product_id='$_SESSION[product_id_for_update]' AND pd.product_id=pp.product_pricing_id";
  //echo $sql;
