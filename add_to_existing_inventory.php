...
<div class="container">
  ...
  <hr>
  <div id="btntxtalign">
  <a href="add_to_inventory.php"><button type="button" class="btn btn-primary">New Inventory</button></a>
</div>
<br>
  <div id="example3">
  <form action="add_to_existing_inventory_process.php" method="POST">
    <label for="name">Select Product name to modify the Inventory:</label>
...
$sql2 = "SELECT product_id, product_name FROM product_details WHERE created_user_company_id = '$_SESSION[company_id_for_db_update]' AND status='y'";
//echo $sql2;
...
<br>
    <center><button type="submit" name="submit" class="btn btn-success">Modify</button></center>
  </form>
</div>
</div>
